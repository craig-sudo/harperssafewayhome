...
# File paths
OUTPUT_DIR = 'output'
# Use the most recent enhanced OCR results
MASTER_CSV = os.path.join(OUTPUT_DIR, 'enhanced_ocr_results_20251024_175414.csv')
...
def run_ai_analyzer():
    ...
    if all_reports:
        ...
        print(f"\n✅ AI Contradiction Report saved to: {ANALYSIS_OUTPUT_CSV}")
        print("Review this report for critical evidence of perjury and contempt.")
    else:
        print("\nℹ️ No major contradictions detected, or insufficient evidence data.")

if __name__ == "__main__":
    if not os.path.exists(OUTPUT_DIR):
        os.makedirs(OUTPUT_DIR)
    
    print("🤖 AI Legal Contradiction Analyzer")
    print("=" * 50)
    print("Analyzing Harper's evidence for contradictions...")
    print(f"Using evidence file: {MASTER_CSV}")
